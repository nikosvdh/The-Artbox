...
$oeuvres = [
    ...
    'Dodomu' =>
        [    
            'id' => 1,
            'img_src' => 'img/clark-van-der-beken.png',
            'title' => 'Dodomu',
            'artist' => 'Mia Tozerski',
    ...
    'Aashaaheen Baadal' =>
        [
            'id' => 2,
            'img_src' => 'img/pawel-czerwinski-3.png',
            'title' => 'Aashaaheen Baadal',
            'artist' => 'Anaisha Devi',
            'description' => "Sur cette oeuvre conceptuelle à la fois organique, minérale et liquide, Anaisha Devi nous transporte
    ...
    'Nightlife Traffic' =>
        [
            'id' => 3,
            'img_src' => 'img/dan-cristian-padure.png',
            'title' => 'Nightlife Traffic',
            'artist' => 'Andrew Forsythe',
            'description' => "Quisque accumsan ultrices ligula vestibulum posuere. Aliquam feugiat ligula eget massa blandit
    ...
    'Le refuge de l\'Havre' => 
        [
            'id' => 4,
            'img_src' => 'img/steve-johnson-5.png',
            'title' => 'Le refuge de l\'Havre',
            'artist' => 'Simon Pelletier',
            'description' => "Nam tempus neque nec felis venenatis auctor. Nam velit risus, lobortis eu quam non, interdum
    ...
    'Red Washover' => 
        [
            'id' => 5,
            'img_src' => 'img/steve-johnson.png',
            'title' => 'Red Washover',
            'artist' => 'Kit Van Der Borght',
            'description' => "Nunc euismod ullamcorper tortor, id efficitur ante interdum in. Integer eu condimentum nulla. Class
    ...
    'Chromatics' => 
        [
            'id' => 6,
            'img_src' => 'img/pawel-czerwinski.png',
            'title' => 'Chromatics',
            'artist' => 'Jean-Michel Delatronchette',
            'description' => "Vivamus commodo non libero at hendrerit. In lacinia dui sit amet pellentesque iaculis. Donec at
    ...
    'Digital Negative' => 
        [
            'id' => 7,
            'img_src' => 'img/jazmin-quaynor.png',
            'title' => 'Digital Negative',
            'artist' => 'Hamish McKee',
            'description' => "Integer in nisl posuere, pulvinar ex ac, tincidunt risus. Nullam vel lorem et leo dignissim
    ...
    'Blast from the past' => 
        [
            'id' => 8,
            'img_src' => 'img/steve-johnson-6.png',
            'title' => 'Blast from the past',
            'artist' => 'Juliette Baskerville',
            'description' => "Nunc fermentum purus dapibus justo fermentum auctor. Maecenas non tincidunt leo. Morbi vitae iaculis
    ...
    'Hurricane' => 
        [
            'id' => 9,
            'img_src' => 'img/victor-grabarczyk.png',
            'title' => 'Hurricane',
    ...
    'La marée rouge' => 
        [
            'id' => 10,
            'img_src' => 'img/pawel-czerwinski-2.png',
            'title' => 'La marée rouge',
            'artist' => 'Martin Rodriguez',
            'description' => "Vivamus quis odio vel ligula feugiat facilisis. Donec eleifend pellentesque massa, ut malesuada est
    ...
    'Asimilacion' => 
        [
            'id' => 11,
            'img_src' => 'img/steve-johnson-2.png',
            'title' => 'Asimilacion',
            'artist' => 'Angel Sanchez-Fernandez',
            'description' => "Mauris ut justo ac mi pretium eleifend. Curabitur sed magna ut elit facilisis pharetra. Maecenas
    ...
    'La Galaxia Gialla' => 
        [
            'id' => 12,
            'img_src' => 'img/fly-d.png',
            'title' => 'La Galaxia Gialla',
            'artist' => 'Eduardo Tancredi',
            'description' => "Mauris maximus, orci sollicitudin ultrices elementum, tellus neque feugiat leo, quis lobortis purus
    ...
    'Puffy Amalgamate' => 
        [
            'id' => 13,
            'img_src' => 'img/orfeas-green.png',
            'title' => 'Puffy Amalgamate',
            'artist' => 'Sandro De Blasi',
            'description' => "Donec semper a massa quis congue. In malesuada lorem ligula, ut posuere magna pulvinar in. Proin
    ...
    'Mirage' => 
        [
            'id' => 14,
            'img_src' => 'img/steve-johnson-4.png',
            'title' => 'Mirage',
            'artist' => 'Stéphanie Kaiser',
            'description' => "Interdum et malesuada fames ac ante ipsum primis in faucibus. Nam iaculis lorem ac ex tristique
    ...
    'Blaue Gelbe Muster' => 
        [
            'id' => 15,
            'img_src' => 'img/steve-johnson-3.png',
            'title' => 'Blaue Gelbe Muster',
            'artist' => 'Adelheid Von Schreiber',
            'description' => "Curabitur dui odio, porta vel tempor sed, consectetur vitae mi. Interdum et malesuada fames ac ante
